puzzle = document.getElementById('game1');
lights = document.getElementById('game2');
guess = document.getElementById('game3');

console.log(puzzle);

puzzle.addEventListener('click', open15);
lights.addEventListener('click', openlights);
guess.addEventListener('click', openguess);

function open15() {
    console.log('abc');
    location.replace('index_15.html');
}

function openlights() {
    location.replace('index_light.html');
}

function openguess() {
    location.replace('index_guess.html');
}
